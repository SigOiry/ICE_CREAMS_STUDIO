...
model name, and output folder. The training settings are available from the gear
after the required data is selected. In Validation, select either a CSV with
predictor and class columns or a multiband TIFF. A TIFF also requires a labelled
