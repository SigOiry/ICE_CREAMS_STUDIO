...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{21},{25},{12},{16},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (100 bytes) */
const char* const cstring = "x\332mJK\016@0\024\274\221+X`AP)\261\235<\365$\242\255\320\366\376\212\215\205Y\314?I;)*d\242\351\312\272\3101\026\262/E\373[\242\037\3443|O\237M\351\3252V\013\177\222\342\211\324\006\030\2129\302\354s\320|;K\346\321#\220~\275c?\363BA{\300\263\213|\001\230\00253";
    ...
    #endif
    #else /* compression: none (150 bytes) */
const char* const bytes = ".?PROJ_COMPILED_VERSIONPROJ_COMPILED_VERSION_STRPROJ_VERSIONPROJ_VERSION_STRcline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
